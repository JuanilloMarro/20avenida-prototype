...
| Saturación | `1.12` |
| Brillo | `0.85` |
| Velo | `#0E0E0F` · opacidad `0.42` · cobertura `100%` |
| Filo especular | `0.85` |
| Elevación | `0.80` |
...
.av-glass{
  ...
  /* con a=0.42 y c=1 las tres valen 0.42 → velo plano */
...
- **Nada de vidrio sobre vidrio.** Lo que va encima de una superficie de vidrio
  se resuelve con relleno sólido o sólo tipografía. El item activo de una barra
  va sólido, no con otra capa de material.
...
- **Coste.** Cada instancia es una capa compuesta con `backdrop-filter`. Con
  ...
  larga de producto.
- Con `--lg-veil-a: 0.42` este material **sí tapa**: sirve para barras y paneles
